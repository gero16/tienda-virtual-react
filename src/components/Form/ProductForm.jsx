        ...
        <>
            <form>
                ...
                <div className="row mb-2">
                    ...
                    <div className="col">
                        <div className="form-outline">
                            <input type="number" className="form-control" name="precio" onChange={(e) => setProduct({...product, precio:e.target.value})} />
                ...
                <div className="row mb-2">
                    <div className="col">
                        <div className="form-outline">
                            <input className="input-stats url-input border border-1" 
                                    type="text" 
                                    placeholder="URL"
                                    name="img"
